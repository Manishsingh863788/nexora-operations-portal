    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden flex items-center justify-between bg-slate-900 text-white px-4 py-3 border-b border-slate-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-bold text-base tracking-tight">NEXORA ERP</span>
      ...
      >
        ...
        <div className="mx-4 mt-4 p-3.5 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-between">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="w-9 h-9 rounded-lg bg-slate-700 font-bold text-sky-400 flex items-center justify-center text-sm shrink-0 border border-slate-600">
              {user?.name.charAt(0)}
            </div>
        ...
        <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-xs">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 text-slate-600 text-xs font-semibold">
              ...
              <span>NEXORA Wholesale Hub</span>
            </div>
